...
export default async function Navbar() {
  return (
    <div className="w-full flex justify-center border border-gray-400 bg-white shadow">
      <div className="w-11/12 sm:w-5/4 md:w-3/4 max-w-screen-md flex justify-between py-4">
        ...
        <div className="flex gap-5 items-center">
          <Input
            className="shadow-md border-gray-300 focus-visible:ring-0 focus-visible:outline-none focus-visible:ring-offset-0 focus-visible:border-gray-700 hidden md:block"
